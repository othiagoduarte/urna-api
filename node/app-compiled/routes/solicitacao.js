...
module.exports = function (app) {
       ...
       var ctrl = app.controllers.solicitacao;
       ...
       app.get('/solicitacao/ByAluno/:idAluno', function () {
       ...
       app.get('/solicitacao/ByProfessor/:idProfessor', function () {
                     ...
                     return regeneratorRuntime.wrap(function _callee4$(_context4) {
                            while (1) {
                                   switch (_context4.prev = _context4.next) {
                                          case 0:
                                                 _context4.next = 2;
                                                 return ctrl.getByProfessor(req, res);
